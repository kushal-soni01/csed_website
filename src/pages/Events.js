...
const sampleEventWithAllDetails = {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1519389950473-47ba0cfaee1d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    summary: 'A fantastic gathering of tech enthusiasts and industry leaders discussing the future of AI and sustainable technology.',
    ...
    speakers: [
      ...
      },
      {
        ...
        photoUrl: 'https://images.unsplash.com/photo-1507003211169-e69adba43d5e?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      ...
      },
      {
        ...
        photoUrl: 'https://images.unsplash.com/photo-1607990281513-88820c681ab2?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    ...
    photos: [
      { url: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', caption: 'Keynote speech in the main auditorium.' },
      { url: 'https://images.unsplash.com/photo-1542744095-291d1f67b591?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', caption: 'Attendees networking during a coffee break.' },
      { url: 'https://images.unsplash.com/photo-1549646481-eb1011867825?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', caption: 'Interactive workshop on ethical AI principles.' },
      { url: 'https://images.unsplash.com/photo-1531545511094-1bc7d0e401b3?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', caption: 'Exhibition hall showcasing new tech.' },
      { url: 'https://images.unsplash.com/photo-1552588147-9f4a86b510ed?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', caption: 'Panel discussion on the future of sustainable energy.' },
    ],
    sponsors: [
      { name: 'Quantum Innovations', logoUrl: 'https://www.google.com/s2/favicons?sz=64&domain_url=google.com', tier: 'Platinum', website: 'https://www.google.com' },
      { name: 'FutureTech Corp', logoUrl: 'https://www.microsoft.com/favicon.ico', tier: 'Platinum', website: 'https://www.microsoft.com' },
      { name: 'EcoConnect Solutions', logoUrl: 'https://www.apple.com/favicon.ico', tier: 'Gold', website: 'https://www.apple.com' },
      { name: 'DataStream Analytics', logoUrl: 'https://www.amazon.com/favicon.ico', tier: 'Gold', website: 'https://www.amazon.com' },
      { name: 'Innovate Minds', logoUrl: 'https://www.facebook.com/favicon.ico', tier: 'Silver', website: 'https://www.facebook.com' },
      { name: 'GreenEnergy Fund', logoUrl: 'https://www.wikipedia.org/favicon.ico', tier: 'Silver', website: 'https://www.wikipedia.org' },
    ],
  };
  ...
  const eventWithoutSomeDetails = {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1596706853760-4965ef25ac41?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    summary: 'A vibrant exhibition showcasing local talent and fostering community engagement through art.',
    descriptionDetails: { // Structured description, but simpler
    ...
    photos: [
      { url: 'https://images.unsplash.com/photo-1616400619175-5be329267f56?q=80&w=1964&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', caption: 'Paintings on display at the fair.' },
      { url: 'https://images.unsplash.com/photo-1606787620864-10025732669e?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', caption: 'Sculptures captivating the audience.' },
      { url: 'https://images.unsplash.com/photo-1579783900882-c0d3f177636f?q=80&w=1945&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', caption: 'Live art demonstration.' },
    ],
  ...
  const eventOldDescription = {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1549414275-c0f56a524a87?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    summary: 'Hands-on workshop on techniques for preserving historical buildings and artifacts.',
    ...
    sponsors: [{ name: 'Local Heritage Fund', logoUrl: 'https://www.unesco.org/themes/favicon.ico', website: 'https://www.unesco.org' }], // One sponsor
  };
